...
x1 = input('x: ')
y1 = input('y: ')
print(gajiens(geimers1, int(x1), int(y1)))

print(geimers2)
x2 = input('x: ')
y2 = input('y: ')
print(gajiens(geimers2, int(x2), int(y2)))

print(geimers1)
x3 = input('x: ')
y3 = input('y: ')
print(gajiens(geimers1, int(x3), int(y3)))

print(geimers2)
x4 = input('x: ')
y4 = input('y: ')
print(gajiens(geimers2, int(x4), int(y4)))

print(geimers1)
x5 = input('x: ')
y5 = input('y: ')
print(gajiens(geimers1, int(x5), int(y5)))

print(geimers1)
x6 = input('x: ')
y6 = input('y: ')
print(gajiens(geimers2, int(x6), int(y6)))

print(geimers1)
x7 = input('x: ')
y7 = input('y: ')
print(gajiens(geimers1, int(x7), int(y7)))

print(geimers1)
x8 = input('x: ')
y8 = input('y: ')
print(gajiens(geimers2, int(x8), int(y8)))

print(geimers1)
x9 = input('x: ')
y9 = input('y: ')
print(gajiens(geimers1, int(x9), int(y9)))
